/*
Package gofpdi wraps the gofpdi PDF library to import existing PDFs as templates. See github.com/draftboardco/gofpdi
...
import (
	realgofpdi "github.com/draftboardco/gofpdi"
	"io"
)
